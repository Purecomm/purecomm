...
function changeLanguage(lang) {
    ...
    var urlData = window.location.pathname.split('/'); // /en/detail/test.html -> ["", "en", "detail", "test.html"]. Taking the whole URL. 
    urlData.splice(0, 2).join('/'); //cut out ["", "en"] Cutting out the language. 
    var newPath = urlData.join('/') // detail/test.html. Getting the new path we want. 

    window.location.href = '/' + lang + '/' + newPath;// /jp-jp/detail/test.html. Adding new path to window location with language. 
}
...
$('#nav-toggle').on('click', function () {
    ...
    $('.mobile-nav-overlay').addClass('active-overlay');
});
